...
class Ui_Dialog(object):
    ...
    def signupWindowShow(self):
        ...
        self.ui2 = MyUi_Dialog()
        self.ui2.setupUi(self.signupWindow)
    ...
    def windowed_signup(self):
        print("Sign up Button Clicked !")
        u = self.ui2.uname_lineEdit.text()
        p = self.ui2.password_lineEdit.text()
    ...
    def signUpCheck(self):
        ...
        self.ui2.signup_btn.clicked.connect(self.windowed_signup)
